...
QString TransactionTableModel::formatTxStatus(const TransactionRecord *wtx) const
{
    ...
    if(wtx->type == TransactionRecord::Generated  || wtx->type == TransactionRecord::StakeBlitz)
    {
...
QString TransactionTableModel::formatTxType(const TransactionRecord *wtx) const
{
    ...
    case TransactionRecord::StakeBlitz:
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case ConfirmedRole:
        ...
        return rec->status.confirmed && !((rec->type == TransactionRecord::Generated || rec->type == TransactionRecord::StakeBlitz) &&
